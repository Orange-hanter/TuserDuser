...
I have implemented the requested RESTful endpoints for authenticated users,
including the necessary database migrations, service logic, and handler wiring.
...
You can verify the new endpoints using the following `curl` commands (assuming
